...
export const DICTIONARY = {
  ua: {
    ...
    roomsSection: {
      title: "Кімнати",
      subtitle: "Ціни та «вільно» для дат:",
    ...
    rooms: [
      {
        ...
        desc: "Окремий жіночий простір, двоярусні ліжка, ортопедичні матраци, розетки біля більшості місць.",
        capacity: "4 місця",
      },
      {
        id: "female-4b",
        name: "Жіночий номер (4 ліжка), друга кімната",
        desc: "Такий самий затишний жіночий номер — у будинку дві чотири місні кімнати для жінок.",
        capacity: "4 місця",
      },
      {
        id: "male-8",
        name: "Чоловічий номер (8 ліжок)",
        desc: "Чоловічий dorm на вісім місць — для тих, хто цінує окремий простір без змішаного заселення.",
        capacity: "8 місць",
      },
      {
        id: "mixed-8",
        name: "Змішаний номер (8 ліжок)",
        desc: "Загальний змішаний номер: PlayStation і книги — в спільній зоні, тут переважно сон і відпочинок.",
        capacity: "8 місць",
      },
    ],
  },
  en: {
    ...
    rooms: [
      {
        id: "female-4a",
        name: "Women's Dorm (4 beds)",
        desc: "Quiet, women-only space. Bunk beds, orthopedic mattresses, power outlets at most beds.",
        capacity: "4 beds",
      },
      {
        id: "female-4b",
        name: "Women's Dorm (4 beds), room two",
        desc: "Equally cozy women-only room — there are two 4-bed rooms for women in the house.",
        capacity: "4 beds",
      },
      {
        id: "male-8",
        name: "Men's Dorm (8 beds)",
        desc: "8-bed men's dorm — for those who value separate space without mixed occupancy.",
        capacity: "8 beds",
      },
      {
        id: "mixed-8",
        name: "Mixed Dorm (8 beds)",
        desc: "Common mixed room: PlayStation and books in common areas, here it's mostly about sleep.",
        capacity: "8 beds",
      },
    ],
  },
